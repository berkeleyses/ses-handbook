...
\textbf{Energy Engineering (EnE):} Chaniqua Butscher ({\fontfamily{qcr}\selectfont chaniqua@berkeley.edu}).

\textbf{Engineering Math and Statistics (EMS) and Environmental Engineering Science (ESS)} Olivia Chan ({\fontfamily{qcr}\selectfont oychan@berkeley.edu}).
